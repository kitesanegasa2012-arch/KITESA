...
# JavaScript for browser-based text-to-speech
def get_audio_js(text, lang='om'):
    ...
    <button onclick="speakText()" class="audio-btn">
        🔊 Sagalee Dhaggeeffadhu
    </button>
    """

# Function to play audio using HTML5 speech synthesis
def play_audio(text, lang='om'):
    """Play audio using browser's speech synthesis"""
    if text and len(text) > 0:
        # Create a unique key for each audio button
        audio_key = f"audio_{hash(text)}_{lang}"
        
        # HTML with JavaScript for speech synthesis
        audio_html = f"""
        <div style="margin: 10px 0;">
            <button onclick="speakText_{audio_key}()" style="
                background: linear-gradient(to right, #667eea 0%, #764ba2 100%);
                color: white;
                border: none;
                border-radius: 50px;
            ...
            function speakText_{audio_key}() {{
                if ('speechSynthesis' in window) {{
                    ...
                    alert('⚠️ Your browser does not support speech synthesis. Please use Chrome or Edge.');
                }}
            }}
            </script>
        </div>
...
def reading_page():
    ...
    lessons = [
        {
            ...
            "text_audio": "Qubee A sirriitti dubbifameera. A - Afaan",
            "letter": "A",
        ...
        },
        {
            ...
            "text_audio": "Qubee B sirriitti dubbifameera. B - Bishaan",
            "letter": "B",
        ...
        },
        {
            "title": "Jecha Bishaan",
            "text": "Bishaan - Water 💧",
            "text_audio": "Jechi Bishaan jedhu dhaga'amaa jira. Bishaan",
            "letter": "B",
        ...
        },
        {
            "title": "Qubee C",
            "text": "C - Cabbana",
            "text_audio": "Qubee C sirriitti dubbifameera. C - Cabbana",
            "letter": "C",
    ...
    with col2:
        ...
        # Audio playback with browser speech synthesis
        audio_text = f"{item['text']}. {item['text_audio']}"
        play_audio(audio_text, 'om')
    ...
    m_questions = [
        {
            ...
            "image": "➕",
            "difficulty": "Salphoo",
            "audio": "Shanii kudhan lama walitti dabala. Deebiin 27"
        },
        {
            "question": "45 - 20 = ?",
            ...
            "image": "➖",
            "difficulty": "Salphoo",
            "audio": "Afurtamii shan keessaa digdama hir'isaa. Deebiin 25"
        },
        {
            "question": "6 × 7 = ?",
            ...
            "audio": "Jahaa torbaan baay'isaa. Deebiin 42"
        },
        {
            "question": "72 ÷ 8 = ?",
            ...
            "image": "➗",
            "difficulty": "Giddugaleessa",
            "audio": "Torbaatamii lama saddeet qoodaa. Deebiin 9"
        }
    ]
...
def quiz_page():
    ...
    quiz_questions = [
        ...
        },
        {
            ...
            "answer": "B",
            "category": "Herregaa",
            "audio": "Torbayyii saddeet walitti dabala. Deebiin 15"
        },
        {
        ...
        },
        {
            ...
            "answer": "C",
            "category": "Herregaa",
            "audio": "Soddoma keessaa kudhan shan hir'isaa. Deebiin 15"
        }
    ]
